...
namespace TestingAndCalibrationLabs.Business.Data.Repository.MetirialTest
{
    public class TestingCategoryLookupRepository : ITestingCategoryLookupRepository
    {
        ...
        public List<TestingCategoryLookupModel> GetTests()
        {
            ...
            return db.Query<TestingCategoryLookupModel>("SELECT * from TestingCategoryLookup").ToList();
        ...
        {
            using IDbConnection db = _connectionFactory.GetConnection;
            return db.Query<TestingCategoryLookupModel>("SELECT a.Name as ManagerName,b.Name as EmpName from TestingCategoryLookup a, TestingCategoryLookup b where a.Id=b.ParentId", new { id }).FirstOrDefault();
