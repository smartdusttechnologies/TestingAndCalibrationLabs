...
//        Web.UI.Models.Record detailToadd = new Web.UI.Models.Record
//        {
//            Name = "India",
//            Description = "Abc"
//        };
...
//            mapper.Setup(m => m.Map<List<SampleModel>, List<Web.UI.Models.Record>>(details)).Returns(MapDetails(details));
//            mapper.Setup(m => m.Map<SampleModel, Web.UI.Models.Record>(details[0])).Returns(MapDetails(details[0]));
//            mapper.Setup(m => m.Map<Web.UI.Models.Record, SampleModel>(detailToadd)).Returns(details[0]);
...
//            Assert.AreEqual(1, (data.Model as List<Web.UI.Models.Record>).Count);
//        }
...
//        private List<Web.UI.Models.Record> MapDetails(List<SampleModel> samples)
//        {
//            List<Web.UI.Models.Record> list = new List<Web.UI.Models.Record>();
//            foreach (var details in samples)
//            {
//                list.Add(new Web.UI.Models.Record { Description = details.Description, Name = details.Name });
//            }
//            return list;
//        }
//        private Web.UI.Models.Record MapDetails(SampleModel details)
//        {
//            return new Web.UI.Models.Record { Description = details.Description, Name = details.Name };
//        }
//        #endregion
