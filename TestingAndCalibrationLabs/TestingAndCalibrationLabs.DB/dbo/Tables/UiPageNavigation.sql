CREATE TABLE [dbo].[UiPageNavigation] (
    ...
    CONSTRAINT [FK_UiPageNavigation_UiNavigationCategory] FOREIGN KEY ([UiNavigationCategoryId]) REFERENCES [dbo].[UiNavigationCategory] ([Id]),
    CONSTRAINT [FK_UiPageNavigation_UiPageType] FOREIGN KEY ([UiPageTypeId]) REFERENCES [dbo].[UiPageType] ([Id])
);
